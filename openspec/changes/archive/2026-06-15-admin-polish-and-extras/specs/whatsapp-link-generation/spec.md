...
> **Change**: `admin-polish-and-extras` (PR#5)
> **Source proposal**: engram `sdd/admin-polish-and-extras/proposal` (#399)
> **Mode**: hybrid (engram + OpenSpec)
> **Depends on**: PR#3 (`payment-qr`) and PR#4 (`notifications` / `service-tracking`)
> **D2 (locked)**: wa.me-only — no Cloud API, no Twilio, no env vars. The client builds the URL; the admin clicks it.
