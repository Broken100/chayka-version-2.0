...
- [ ] 2.1 Add multer + types to package.json
- [ ] 2.2 Create `server/uploads/.gitkeep` + gitignore
- [ ] 2.3 Create multer config with UUID + mime + size cap
- [ ] 2.4 Mount express.static on `/uploads/:filename`
- [ ] 2.5 Add `POST /api/admin/uploads` (201/413/415/401)
- [ ] 2.6 Add `DELETE /api/admin/uploads/:filename` (204/404)
- [ ] 2.7 Tighten E.164 regex on `whatsappNumber` + `customerPhone`
- [ ] 2.8 Add `useUploadImage` / `useDeleteUploadedImage`
- [ ] 2.9 Build MenuManager file picker + thumbnail + Remove
- [ ] 2.10 SettingsPanel WhatsApp input `type="tel"`
- [ ] 2.11 CheckoutForm customer phone input `type="tel"`
- [ ] 2.12 Add uploads integration test suite
- [ ] 2.13 Extend validation test for E.164
...
- [ ] 3.1 Add `transfer_qr_url` column to `businessConfig`
- [ ] 3.2 Add `POST /api/admin/qr` with previous-file cleanup
- [ ] 3.3 Add `DELETE /api/admin/qr`
- [ ] 3.4 Expose `transfer_qr_url` in business-config GET
- [ ] 3.5 Add QR upload/delete mutations + row mapper extension
- [ ] 3.6 Add "Pagos" section to `SettingsPanel`
- [ ] 3.7 Render QR in `PaymentModal` for transfer method
- [ ] 3.8 Add QR settings integration test suite
